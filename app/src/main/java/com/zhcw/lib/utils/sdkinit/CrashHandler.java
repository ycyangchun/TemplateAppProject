...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    public String getSavePath() {
        if (this.haveSD()) {
            return getSDPath() + File.separator + Constants.packageName + "/error/";
        } else {
            return mContext.getFilesDir() + File.separator + Constants.packageName + "/error/";
        }
    }
    ...
    public void collectDeviceInfo(Context ctx) {
        try {
            ...
            if (pi != null) {
                ...
                infos.put("MemTotal", FileUtilSupply.getMemInfoIype(ctx, "MemTotal"));
                infos.put("MemFree", FileUtilSupply.getMemInfoIype(ctx, "MemFree"));
            }
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                ...
                FileOutputStream fos = new FileOutputStream(crashPath + File.separator +fileName);
