 ...
 * ================================================
 */
public abstract class ZIPresenter implements IPresenter, LifecycleObserver {
     ...
     * @param rootView
     */
    public ZIPresenter(IView rootView) {
    ...
    public void onStart() {
        ...
        if (null != mRootView && mRootView instanceof LifecycleOwner) {
